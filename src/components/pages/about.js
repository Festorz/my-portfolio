...
const About = () => {
  ...
  return (
    <MainBox mtop={70}>
      <Box align="center">
        <StyledText mcolor={"#fff"}>
          About <b style={{ color: "#ff8f00" }}>Me</b>{" "}
        </StyledText>
      </Box>
      <StyledSection>
        <StyledPaper>
          ...
          <DescBox>
            ...
            <DescriptionText
              component="a"
              href="https://www.linkedin.com/in/festus-kirui-566451205/"
            >
              My Profile
            </DescriptionText>
          </DescBox>
          <DescBox>
            ...
            <DescriptionText component="a" href="https://github.com/festorz">
              My Projects
            </DescriptionText>
          </DescBox>
        </StyledPaper>
      ...
      <Box align="center">
        <StyledText mfontsize={35} mcolor={"#fff"} mtop={50}>
          My skills
        </StyledText>
      </Box>
            ...
            <StyledGridItem item key={data.id}>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Box sx={{ width: "100%", mr: 1, ml: 1 }}>
                  <ColoredBox>
                    <ColoredBox mcolor={"#27AE60"} mwidth={data.level}>
                      {data.level}
                    </ColoredBox>
                  </ColoredBox>
                </Box>
                <Box sx={{ minWidth: 35 }}>
                  <StyledText mfontsize={15} mcolor={"#fff"} mbold>
                    {data.level}%
                  </StyledText>
                </Box>
              </Box>
      ...
      <Box align="">
        {education.map((data) => (
          <StyledPaper mwidth={"70%"}>
            ...
            >
              {data.role}{" "}
              <b style={{ color: "#27AE60" }}> - {data.institution}</b>
            </DescriptionText>
            <TimeBox>
              <DescriptionText mcolor={"#fff"} mfontsize={14}>
                {data.duration}
              </DescriptionText>
            </TimeBox>
            {data.skills.map((skl) => (
              <SkillsBox key={skl.id}>
                <Box sx={{ mr: 1, ml: 1 }}>
                  <StyledIcon mcolor={amber[800]} mfontsize={14}>
