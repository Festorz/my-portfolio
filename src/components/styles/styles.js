import { Avatar, Box, Divider, Grid, Icon, Paper, Typography } from "@material-ui/core";
...
export const StyledText = styled(Box)(({ theme, mcolor, malign, mfontsize, mvariant, mtop, mbold, tstyle }) => ({
